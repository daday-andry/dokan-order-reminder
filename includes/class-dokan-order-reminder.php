...
class Dokan_Order_Reminder {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Dokan_Order_Reminder_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'DOKAN_ORDER_REMINDER_VERSION' ) ) {
			$this->version = DOKAN_ORDER_REMINDER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'dokan-order-reminder';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dokan-order-reminder-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dokan-order-reminder-i18n.php';
	 ...
	 *
	 * Uses the Dokan_Order_Reminder_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Dokan_Order_Reminder_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Dokan_Order_Reminder_Loader    Orchestrates the hooks of the plugin.
	 */
